...
GET_ENDPOINTS = [
    ...
    ("/agronomist/requirements", {Role.AGRONOMIST}),
    ("/agronomist/farmers", {Role.AGRONOMIST}),
    ...
    ("/finance/reconciliation", {Role.FINANCE}),
    (f"/finance/reconciliation/{DUMMY_ID}", {Role.FINANCE}),
    ("/mofa/compliance-report", {Role.FINANCE}),
    ("/mofa/import-records", {Role.FINANCE}),
    ("/reporting/dashboard", {Role.FINANCE}),
    ("/dashboard/control-centre", {Role.AGRONOMIST, Role.LOGISTICS, Role.FINANCE, Role.SUPER_ADMIN}),
